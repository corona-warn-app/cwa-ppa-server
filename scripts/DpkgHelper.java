 ...
 * /var/lib/dpkg/status.d/ Generates the file from directory content so Clair can work on it. Needs to be a java script,
 * as it is run on gcr.io/distroless/java:11, which has no bash.
 */
class DpkgHelper {
