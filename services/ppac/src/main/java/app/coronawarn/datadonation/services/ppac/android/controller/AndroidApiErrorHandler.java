...
public class AndroidApiErrorHandler extends ResponseEntityExceptionHandler {
   ...
   */
  private static final Map<Class<? extends RuntimeException>, ApiErrorCode> ERROR_STATES =
      Map.of(FailedJwsParsing.class, ApiErrorCode.JWS_SIGNATURE_VERIFICATION_FAILED,
          FailedSignatureVerification.class, ApiErrorCode.JWS_SIGNATURE_VERIFICATION_FAILED,
          SaltNotValidAnymore.class, ApiErrorCode.JWS_SIGNATURE_VERIFICATION_FAILED,
          FailedAttestationTimestampValidation.class, ApiErrorCode.ATTESTATION_EXPIRED,
          NonceCouldNotBeVerified.class, ApiErrorCode.NONCE_MISMATCH,
          ApkPackageNameNotAllowed.class, ApiErrorCode.APK_PACKAGE_NAME_MISMATCH,
          ApkCertificateDigestsNotAllowed.class, ApiErrorCode.APK_CERTIFICATE_MISMATCH);
  ...
  protected ResponseEntity<Object> handleAuthenticationErrors(RuntimeException runtimeException,
    ...
    return handleExceptionInternal(runtimeException, getErrorCode(runtimeException),
  ...
  protected ResponseEntity<Object> handleInternalServerErrors(RuntimeException runtimeException,
    ...
    return new ResponseEntity<>(ApiErrorCode.INTERNAL_SERVER_ERROR, new HttpHeaders(),
        HttpStatus.INTERNAL_SERVER_ERROR);
  }

  private Object getErrorCode(RuntimeException runtimeException) {
    return ERROR_STATES.getOrDefault(runtimeException.getClass(), ApiErrorCode.UNKNOWN);
  }
}
