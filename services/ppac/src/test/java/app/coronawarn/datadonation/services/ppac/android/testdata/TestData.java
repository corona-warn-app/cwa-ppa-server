...
import static app.coronawarn.datadonation.services.ppac.android.attestation.signature.JwsGenerationUtil.createCompactSerializedJws;
...
public class TestData {
  ...
  public static class CardinalityTestData {
    ...
    public static PPADataRequestAndroid buildPayloadWithExposureRiskMetrics(final String jws, final String salt,
        final Integer numberOFElements) throws Exception {
    ...
    public static PPADataRequestAndroid buildPayloadWithExposureWindowMetrics(final String jws, final String salt,
    ...
    public static PPADataRequestAndroid buildPayloadWithKeySubmission(final String jws, final String salt,
        final Integer numberOfElements) {
      return PPADataRequestAndroid.newBuilder().setAuthentication(newAuthenticationObject(jws, salt))
          .setPayload(
    ...
    public static PPADataRequestAndroid buildPayloadWithScanInstancesMetrics(final String jws, final String salt,
        final Integer numberOfElements) {
      return PPADataRequestAndroid.newBuilder().setAuthentication(newAuthenticationObject(jws, salt))
          .setPayload(
              PPADataAndroid.newBuilder().addAllExposureRiskMetadataSet(Set.of(TestData.getValidExposureRiskMetadata()))
    ...
    public static PPADataRequestAndroid buildPayloadWithTestResults(final String jws, final String salt,
        final Integer numberOfElements) {
      return PPADataRequestAndroid.newBuilder().setAuthentication(newAuthenticationObject(jws, salt))
          .setPayload(
              PPADataAndroid.newBuilder().addAllExposureRiskMetadataSet(Set.of(TestData.getValidExposureRiskMetadata()))
    ...
    private static <T> Set<T> setOfElements(final int numberOfElements, final Supplier<T> supplier) {
  ...
  public static String getJwsPayloadAttestationValidityExpired() throws Exception {
    final Map<String, Serializable> payloadValues = new HashMap<>(getJwsPayloadDefaultValue());
    payloadValues.put("timestampMs", String.valueOf(Instant.now().minusSeconds(8000).toEpochMilli()));
    return createCompactSerializedJws(payloadValues);
  }

  private static Map<String, Serializable> getJwsPayloadDefaultValue() throws Exception {
  ...
  public static String getJwsPayloadValues() throws Exception {
    final Map<String, Serializable> payloadValues = getJwsPayloadDefaultValue();
    return createCompactSerializedJws(payloadValues);
  }

  public static String getJwsPayloadWithBasicIntegrityViolation() throws Exception {
    final Map<String, Serializable> payloadValues = new HashMap<>(getJwsPayloadDefaultValue());
    payloadValues.put("basicIntegrity", false);
    return createCompactSerializedJws(payloadValues);
  }

  public static String getJwsPayloadWithCtsMatchViolation() throws Exception {
    final Map<String, Serializable> payloadValues = new HashMap<>(getJwsPayloadDefaultValue());
    payloadValues.put("ctsProfileMatch", false);
    return createCompactSerializedJws(payloadValues);
  }

  public static String getJwsPayloadWithEvaluationType(final String evaluationType) throws Exception {
    final Map<String, Serializable> payloadValues = new HashMap<>(getJwsPayloadDefaultValue());
    payloadValues.put("evaluationType", evaluationType);
    return createCompactSerializedJws(payloadValues);
  }

  public static String getJwsPayloadWithIntegrityFlagsChecked() throws Exception {
    final Map<String, Serializable> payloadValues = new HashMap<>(getJwsPayloadDefaultValue());
  ...
  public static String getJwsPayloadWithNonce(final String nonce) throws Exception {
    final Map<String, Serializable> payloadValues = new HashMap<>(getJwsPayloadDefaultValue());
    payloadValues.put("nonce", nonce);
    return createCompactSerializedJws(payloadValues);
  }

  public static String getJwsPayloadWithUnacceptedApkCertificateDigestHash() throws Exception {
    final Map<String, Serializable> payloadValues = new HashMap<>(getJwsPayloadDefaultValue());
    payloadValues.put("apkCertificateDigestSha256", new String[] { "" });
    return createCompactSerializedJws(payloadValues);
  }

  public static String getJwsPayloadWrongApkPackageName() throws Exception {
    final Map<String, Serializable> payloadValues = new HashMap<>(getJwsPayloadDefaultValue());
  ...
  public static PPANewExposureWindow getValidExposureWindow(final Set<PPAExposureWindowScanInstance> scanInstances) {
    return PPANewExposureWindow.newBuilder()
  ...
  public static String loadJwsWithExpiredCertificates() throws Exception {
    final InputStream fileStream = TestData.class.getResourceAsStream("/jwsSamples/invalid_samples.properties");
    final Properties properties = new Properties();
    properties.load(fileStream);
    return (String) properties.get("expiredCertificates");
  }

  public static PPACAndroid newAuthenticationObject(final String jws, final String salt) {
    final Builder builder = PPACAndroid.newBuilder();
    if (jws != null) {
