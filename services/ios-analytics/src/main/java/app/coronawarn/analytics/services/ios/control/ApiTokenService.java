...
public class ApiTokenService {
    ...
    public ApiTokenService(ApiTokenRepository apiTokenRepository, TimeUtils timeUtils, IosDeviceApiClient iosDeviceApiClient) {
    ...
    @Transactional
    public void authenticate(IosDeviceData perDeviceData, String apiToken, String deviceToken, String transactionId, Timestamp timestamp) {
        apiTokenRepository
                .findById(apiToken)
                .ifPresentOrElse(
    ...
    private void authenticateNewApiToken(IosDeviceData iosDeviceData,
        ...
        if (yearMonth.equals(lastUpdated)) {
            ...
            logger.warn(msg);
            throw new ApiTokenAlreadyUsedException(msg);
        }
    ...
    private void authenticateExistingApiToken(ApiToken apiToken) {
        ...
        if (now.isAfter(apiToken.getExpirationDate())) {
            ...
            logger.error(msg);
            throw new ApiTokenExpiredException(msg);
        }
