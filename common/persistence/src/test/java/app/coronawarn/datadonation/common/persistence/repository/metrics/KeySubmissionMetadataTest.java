...
public class KeySubmissionMetadataTest {
  ...
  class TestWithClientMetadataEquals {
    ...
    void testEqualsOnAdvancedConsentGiven() {
      KeySubmissionMetadataWithClientMetadata noAdvancedConsentGiven = new KeySubmissionMetadataWithClientMetadata(
          1L, true, true, true, true, null, 1, clientMetadataDetails, technicalMetadata);
      ...
      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(alteredAdvancedConsentGiven);
      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(noAdvancedConsentGiven);
      assertThat(noAdvancedConsentGiven)
          .isNotEqualTo(keySubmissionMetadataWithClientMetadata);
    }

    @Test
    void testEqualsOnClientMetadata() {
      KeySubmissionMetadataWithClientMetadata noClientMetadata = new KeySubmissionMetadataWithClientMetadata(
          1L, true, true, true, true, true, 1, null, technicalMetadata);

      KeySubmissionMetadataWithClientMetadata alteredClientMetadata = new KeySubmissionMetadataWithClientMetadata(
          1L, true, true, true, true, true, 1, alteredClientMetadataDetails, technicalMetadata);

      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(alteredClientMetadata);
      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(noClientMetadata);
      assertThat(noClientMetadata)
          .isNotEqualTo(keySubmissionMetadataWithClientMetadata);
    }

    @Test
    void testEqualsOnId() {
      KeySubmissionMetadataWithClientMetadata noId = new KeySubmissionMetadataWithClientMetadata(
          null, true, true, true, true, true, 1, clientMetadataDetails, technicalMetadata);

      KeySubmissionMetadataWithClientMetadata alteredId = new KeySubmissionMetadataWithClientMetadata(
          2L, true, true, true, true, true, 1, clientMetadataDetails, technicalMetadata);

      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(alteredId);
      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(noId);
      assertThat(noId)
          .isNotEqualTo(keySubmissionMetadataWithClientMetadata);
    ...
    void testEqualsOnLastSubmissionFlowScreen() {
      ...
      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(alteredLastSubmissionFlowScreen);
      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(noLastSubmissionFlowScreen);
      assertThat(noLastSubmissionFlowScreen)
          .isNotEqualTo(keySubmissionMetadataWithClientMetadata);
    }

    @Test
    void testEqualsOnSubmitted() {
      KeySubmissionMetadataWithClientMetadata noSubmitted = new KeySubmissionMetadataWithClientMetadata(
          1L, null, true, true, true, true, 1, clientMetadataDetails, technicalMetadata);

      KeySubmissionMetadataWithClientMetadata alteredSubmitted = new KeySubmissionMetadataWithClientMetadata(
          1L, false, true, true, true, true, 1, clientMetadataDetails, technicalMetadata);

      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(alteredSubmitted);
      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(noSubmitted);
      assertThat(noSubmitted)
          .isNotEqualTo(keySubmissionMetadataWithClientMetadata);
    }

    @Test
    void testEqualsOnSubmittedAfterCancel() {
      KeySubmissionMetadataWithClientMetadata noSubmittedAfterCancel = new KeySubmissionMetadataWithClientMetadata(
          1L, true, true, null, true, true, 1, clientMetadataDetails, technicalMetadata);
      ...
      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(alteredSubmittedAfterCancel);
      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(noSubmittedAfterCancel);
      assertThat(noSubmittedAfterCancel)
          .isNotEqualTo(keySubmissionMetadataWithClientMetadata);
    }
    ...
    void testEqualsOnSubmittedAfterSymptomFlow() {
      ...
      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(alteredSubmittedAfterSymptomFlow);
      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(noSubmittedAfterSymptomFlow);
      assertThat(noSubmittedAfterSymptomFlow)
          .isNotEqualTo(keySubmissionMetadataWithClientMetadata);
    }

    @Test
    void testEqualsOnSubmittedInBackground() {
      KeySubmissionMetadataWithClientMetadata noSubmittedInBackground = new KeySubmissionMetadataWithClientMetadata(
          1L, true, null, true, true, true, 1, clientMetadataDetails, technicalMetadata);
      ...
      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(alteredSubmittedInBackground);
      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(noSubmittedInBackground);
      assertThat(noSubmittedInBackground)
          .isNotEqualTo(keySubmissionMetadataWithClientMetadata);
    }

    @Test
    void testEqualsOnTechnicalMetadata() {
      KeySubmissionMetadataWithClientMetadata noTechnicalMetadata = new KeySubmissionMetadataWithClientMetadata(
          1L, true, true, true, true, true, 1, clientMetadataDetails, null);

      KeySubmissionMetadataWithClientMetadata alteredTechnicalMetadata = new KeySubmissionMetadataWithClientMetadata(
          1L, true, true, true, true, true, 1, clientMetadataDetails,
          KeySubmissionMetadataTest.alteredTechnicalMetadata);

      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(alteredTechnicalMetadata);
      assertThat(keySubmissionMetadataWithClientMetadata)
          .isNotEqualTo(noTechnicalMetadata);
      assertThat(noTechnicalMetadata)
          .isNotEqualTo(keySubmissionMetadataWithClientMetadata);
    }
  }
  ...
  class TestWithUserMetadataEquals {
    ...
    void testEqualsOnHoursSinceHighRiskWarningAtTestRegistration() {
      ...
      assertThat(keySubmissionMetadataWithUserMetadata)
          .isNotEqualTo(noHoursSinceHighRiskWarningAtTestRegistration);
    ...
    void testEqualsOnHoursSinceReceptionOfTestResult() {
      ...
      assertThat(keySubmissionMetadataWithUserMetadata)
          .isNotEqualTo(alteredHoursSinceReceptionOfTestResult);
      assertThat(keySubmissionMetadataWithUserMetadata)
          .isNotEqualTo(noHoursSinceReceptionOfTestResult);
      assertThat(noHoursSinceReceptionOfTestResult)
          .isNotEqualTo(keySubmissionMetadataWithUserMetadata);
    }

    @Test
    void testEqualsOnHoursSinceTestRegistration() {
      KeySubmissionMetadataWithUserMetadata noHoursSinceTestRegistration = new KeySubmissionMetadataWithUserMetadata(
          1L, true, true, true, 1, null, 1, 1, userMetadataDetails, technicalMetadata);
      ...
      assertThat(keySubmissionMetadataWithUserMetadata)
          .isNotEqualTo(alteredHoursSinceTestRegistration);
      assertThat(keySubmissionMetadataWithUserMetadata)
          .isNotEqualTo(noHoursSinceTestRegistration);
      assertThat(noHoursSinceTestRegistration)
          .isNotEqualTo(keySubmissionMetadataWithUserMetadata);
    }

    @Test
    void testEqualsOnId() {
      KeySubmissionMetadataWithUserMetadata noId = new KeySubmissionMetadataWithUserMetadata(
          null, true, true, true, 1, 1, 1, 1, userMetadataDetails, technicalMetadata);

      KeySubmissionMetadataWithUserMetadata alteredId = new KeySubmissionMetadataWithUserMetadata(
          2L, true, true, true, 1, 1, 1, 2, userMetadataDetails, technicalMetadata);
    ...
    @Test
    void testEqualsOnSubmitted() {
      KeySubmissionMetadataWithUserMetadata noSubmitted = new KeySubmissionMetadataWithUserMetadata(
          1L, null, true, true, 1, 1, 1, 1, userMetadataDetails, technicalMetadata);

      KeySubmissionMetadataWithUserMetadata alteredSubmitted = new KeySubmissionMetadataWithUserMetadata(
          1L, false, true, true, 1, 1, 1, 2, userMetadataDetails, technicalMetadata);
    ...
    @Test
    void testEqualsOnSubmittedAfterSymptomFlow() {
      KeySubmissionMetadataWithUserMetadata noSubmittedAfterSymptomFlow = new KeySubmissionMetadataWithUserMetadata(
          1L, true, null, true, 1, 1, 1, 1, userMetadataDetails, technicalMetadata);
    ...
    void testEqualsOnSubmittedWithTeletan() {
      KeySubmissionMetadataWithUserMetadata noSubmittedWithTeletan = new KeySubmissionMetadataWithUserMetadata(
          1L, true, true, null, 1, 1, 1, 1, userMetadataDetails, technicalMetadata);

      KeySubmissionMetadataWithUserMetadata alteredSubmittedWithTeletan = new KeySubmissionMetadataWithUserMetadata(
          1L, true, true, false, 1, 1, 1, 2, userMetadataDetails, technicalMetadata);

      assertThat(keySubmissionMetadataWithUserMetadata)
          .isNotEqualTo(alteredSubmittedWithTeletan);
      assertThat(keySubmissionMetadataWithUserMetadata)
          .isNotEqualTo(noSubmittedWithTeletan);
      assertThat(noSubmittedWithTeletan)
          .isNotEqualTo(keySubmissionMetadataWithUserMetadata);
    }

    @Test
    void testEqualsOnTechnicalMetadata() {
      KeySubmissionMetadataWithUserMetadata noTechnicalMetadata = new KeySubmissionMetadataWithUserMetadata(
          1L, true, true, true, 1, 1, 1, 1, userMetadataDetails, null);

      KeySubmissionMetadataWithUserMetadata alteredTechnicalMetadata = new KeySubmissionMetadataWithUserMetadata(
          1L, true, true, true, 1, 1, 1, 2, userMetadataDetails, KeySubmissionMetadataTest.alteredTechnicalMetadata);
    ...
    void testEqualsOnUserMetadata() {
      KeySubmissionMetadataWithUserMetadata noUserMetadata = new KeySubmissionMetadataWithUserMetadata(
          1L, true, true, true, 1, 1, 1, 1, null, technicalMetadata);

      KeySubmissionMetadataWithUserMetadata alteredUserMetadata = new KeySubmissionMetadataWithUserMetadata(
          1L, true, true, true, 1, 1, 1, 2, alteredUserMetadataDetails, technicalMetadata);

      assertThat(keySubmissionMetadataWithUserMetadata)
          .isNotEqualTo(alteredUserMetadata);
      assertThat(keySubmissionMetadataWithUserMetadata)
          .isNotEqualTo(noUserMetadata);
      assertThat(noUserMetadata)
          .isNotEqualTo(keySubmissionMetadataWithUserMetadata);
    }
